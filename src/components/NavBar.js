      ...
      <Navbar className="container py-3" expand="lg">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto navlinks">
            ...
            <NavDropdown className="navlink navlink--button-1 mx-0 px-3" title="Sign In" id="navlink--button-1">
            ...
            <NavDropdown className="navlink navlink--button-2 text-white mx-0 px-3" title="Sign Up" id="navlink--button-2">
